            ...
            (o.prototype.defaults = {
                ...
                (o.prototype.reveal = function (t, e, n, i) {
                    ...
                    n &&
                        'number' == typeof n &&
                        ((m = a()),
                        (v = N.sequences[m] = { id: m, interval: n, elemIds: [], active: !1 }));
        ...
        !(function (e, n) {
            ...
            function m(t) {
                return (
                    'true' === t ||
                    ('false' !== t &&
                        ('null' === t ? null : t === +t + '' ? +t : Wt.test(t) ? JSON.parse(t) : t))
                );
            }
            function y(t, e, n) {
                var i;
            ...
            function V(t, e, n) {
                for (
                    var i, o = (Q.tweeners[e] || []).concat(Q.tweeners['*']), s = 0, r = o.length;
                    s < r;
                    s++
                )
                    ...
                    if ((i = Q.prefilters[s].call(l, t, u, l.opts)))
                        return (
                            yt.isFunction(i.stop) &&
                                (yt._queueHooks(l.elem, l.opts.queue).stop = yt.proxy(i.stop, i)),
                            i
                        );
                return (
                    yt.map(u, V, l),
            ...
            var Ct = (function (t) {
                ...
                function n() {
                    function t(n, i) {
                        return (
                            e.push(n + ' ') > w.cacheLength && delete t[e.shift()], (t[n + ' '] = i)
                        );
                    }
                    var e = [];
                    return t;
                            ...
                            pseudos: {
                                ...
                                contains: i(function (t) {
                                    return (
                                        ...
                                        function (e) {
                                            return (
                                                (e.textContent || e.innerText || T(e)).indexOf(t) >
                                                -1
                                            );
                                        }
                                    );
            ...
            (yt.filter = function (t, e, n) {
                ...
                yt.fn.extend({
                    ...
                    is: function (t) {
                        return !!l(this, 'string' == typeof t && St.test(t) ? yt(t) : t || [], !1)
                            .length;
                    },
                });
            var At,
                ...
                if (((n = n || At), 'string' == typeof t)) {
                    ...
                    if (i[1]) {
                        if (
                            ...
                            yt.merge(
                                this,
                                yt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : rt, !0)
                            ),
                    ...
                    return (
                        (o = rt.getElementById(i[2])), o && ((this[0] = o), (this.length = 1)), this
                    );
                }
                return t.nodeType
                ...
                yt.fn.extend({
                    data: function (t, e) {
                        ...
                        if (void 0 === t) {
                            if (
                                this.length &&
                                ((o = Ht.get(s)), 1 === s.nodeType && !Ft.get(s, 'hasDataAttrs'))
                            ) {
                                for (n = r.length; n--; )
                                    r[n] &&
                                        ((i = r[n].name),
