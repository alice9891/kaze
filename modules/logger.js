 ...
 * @author 서동해
 * @email kaze@aivar.kr
 * @create date 2023-03-23 16:50:21
 * @modify date 2023-03-23 16:50:21
 * @desc [description]
 */
...
const logger = winston.createLogger({
    ...
    format: combine(
        ...
        label({ label: 'myFiitApi' }), // 어플리케이션 이름
        logFormat // log 출력 포맷
    ...
    transports: [
        ...
        new winstonDaily({
            ...
            filename: `%DATE%.error.log`, // 에러 로그는 2023-03-21.error.log 형식으로 저장
            maxFiles: 30,
            zippedArchive: true,
        }),
        // new winstonDaily({
